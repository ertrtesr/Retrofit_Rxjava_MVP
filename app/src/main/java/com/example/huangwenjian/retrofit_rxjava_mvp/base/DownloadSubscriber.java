...
public class DownloadSubscriber extends Subscriber<ResponseBody> {
    ...
    public void onNext(ResponseBody responseBody) {
        try {
            System.out.println(mRequestUrl);
            ...
            fileInfo.setLength(mTotalLength);
            fileInfo.setFileName("11.jpg");
            fileInfo.setDownloadPath(FileUtils.getDownloadDir() + fileInfo.getFileName());
    ...
    public void onEvent(UrlEvent urlEvent) {
        this.mRequestUrl = urlEvent.getUrl();
    }
}
